...
if [[ "${JAVA_OPTS}" == *-Xmx* ]]; then
  export JAVA_TOOL_OPTIONS=${JAVA_TOOL_OPTIONS:-"-Dfile.encoding=UTF-8 -Dskywalking.agent.servicename=rainbond -Dskywalking.collector.backendservice=127.0.0.1:11800
